...
def main(args):
  ...
  print("merge captions for L to metadata json.")
  for image_path in tqdm(image_paths):
    ...
    metadata[image_key]['captionL'] = caption
    if args.debug:
...
def setup_parser() -> argparse.ArgumentParser:
  ...
  parser.add_argument("--caption_extension", type=str, default=".txt", help="extension of caption file / 読み込むキャプションファイルの拡張子")
